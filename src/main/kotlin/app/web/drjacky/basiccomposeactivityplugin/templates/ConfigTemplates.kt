...
fun composeCompilerConfig(packageName: String): String = """
...
$packageName.core.domain.**
""".trimIndent()

fun detektBaselineXml(): String = """
<?xml version="1.0" ?>
<SmellBaseline>
...
naming:
  ...
  ConstructorParameterNaming:
    ...
    excludeClassPattern: '${dollarSign}^'
  EnumNaming:
    active: true
    excludes: ['**/test/**', '**/androidTest/**', '**/commonTest/**', '**/jvmTest/**', '**/jsTest/**', '**/iosTest/**']
